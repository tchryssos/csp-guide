...
const BadForm = () => (
	<PageWrapper>
		...
		<p>
			You&apos;ll see that a request has been made to Google (blocked by CORB). This is because the <CodeWord>onerror</CodeWord> function fires when the image tag can&apos;t fetch an image. A malicious user could make that javascript do anything, including bounce user cookies to their own server.
		</p>
		<p>
